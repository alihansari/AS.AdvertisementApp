...
namespace AS.AdvertisementApp.Business.Services
{
        ...
        where T : BaseEntity
    {
        ...
        public async Task<IResponse<IDto>> GetByIdAsync<IDto>(int id)
        {
            ...
            if (data == null)
                return new Response<IDto>(ResponseType.NotFound, $"{id} sine sahip data bulunamadı");
        ...
        public async Task<IResponse<UpdateDto>> UpdateAsync(UpdateDto dto)
        {
            ...
            if (result.IsValid)
            {
                ...
                {
                    return new Response<UpdateDto>(ResponseType.NotFound, $"{dto.Id} disine sahip data bulunamadı");
                }
